    ...
    <form id="burger-form" @submit="createBurger">
        ...
        <div class="input-container">
            ...
            <select name="carne" id="carne" v-model="carne">
                <option value="">Selecione a opção de carne</option>
                <option v-for="carne in carnes" :key="carne.id" :value="carne.tipo"> {{ carne.tipo }}</option>
            </select>
        </div>
        
        <div id="opcionais-container" class="input-container">
            <label id="opcionais-title" for="adicional">Selecione os opcionais:</label>
            <div class="checkbox-container" v-for="adicional in adicionaisData" :key="adicional.id">
...
export default {
    ...
    methods: {
        async getIngredientes(){
            ...
            this.adicionaisData = data.opcionais
        },
